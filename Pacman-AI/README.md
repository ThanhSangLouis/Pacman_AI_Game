...
| ----- | ---------------------------- | ---------------------- | -------------------------------------------- | -------------------- |
| 1     | Ăn 1 food, không có ghost    | Mê cung tĩnh           | BFS, DFS, UCS, Q-Learning                    | Không có             |
| 2     | Ăn 1 food, có ghost đứng yên | Ghost thụ động         | BFS, DFS, UCS, Greedy, Beam Search, A*       | Di chuyển ngẫu nhiên |
| 3     | Nhiều food, ghost đi quanh   | Ghost tuần tra khu vực | Hill Climbing, Simulated Annealing           | Random theo vùng     |
